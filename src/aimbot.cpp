...
void aimbot::run(user_cmd_t* cmd)
{
...
void aimbot::set_aim_angle(user_cmd_t* cmd, c_base_player* entity, const vec3& aim_punch)
{
	switch (m_aim_type) {
	case 0: {
...
void aimbot::do_autopistol(user_cmd_t* cmd, c_base_weapon* weapon)
{
