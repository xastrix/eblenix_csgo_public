...
#define V_ESP_OFFSCREEN_LINES_ENABLED "esp->offscreen_lines->enabled"
#define V_ESP_OFFSCREEN_LINES_COL "esp->offscreen_lines->col"
#define V_ESP_OFFSCREEN_LINES_COL_R V_ESP_OFFSCREEN_LINES_COL R_COL_P
#define V_ESP_OFFSCREEN_LINES_COL_G V_ESP_OFFSCREEN_LINES_COL G_COL_P
#define V_ESP_OFFSCREEN_LINES_COL_B V_ESP_OFFSCREEN_LINES_COL B_COL_P
