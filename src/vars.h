...
struct vars
{
	void init()
	{
		...
		set(V_ESP_OFFSCREEN_LINES_ENABLED, false);
		set(V_ESP_OFFSCREEN_LINES_COL_R, 255);
		set(V_ESP_OFFSCREEN_LINES_COL_G, 255);
		set(V_ESP_OFFSCREEN_LINES_COL_B, 255);
		...
		set(V_MISC_VISUAL_ASPECT_RATIO_VALUE, 1.30f);
