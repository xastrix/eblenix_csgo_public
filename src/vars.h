...
public:
	void init() {
		...
		set(V_ESP_HEALTH_GRADIENT_COL_R, 255);
		set(V_ESP_HEALTH_GRADIENT_COL_G, 255);
		set(V_ESP_HEALTH_GRADIENT_COL_B, 255);
		set(V_ESP_HEALTH_GRADIENT_COL2_R, 255);
		set(V_ESP_HEALTH_GRADIENT_COL2_G, 255);
		set(V_ESP_HEALTH_GRADIENT_COL2_B, 255);
		...
		set(V_ESP_ARMOR_GRADIENT_COL_R, 255);
		set(V_ESP_ARMOR_GRADIENT_COL_G, 255);
		set(V_ESP_ARMOR_GRADIENT_COL_B, 255);
		set(V_ESP_ARMOR_GRADIENT_COL2_R, 255);
		set(V_ESP_ARMOR_GRADIENT_COL2_G, 255);
		set(V_ESP_ARMOR_GRADIENT_COL2_B, 255);
