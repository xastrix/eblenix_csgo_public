...
public:
	void init() {
		...
		set(V_AIMBOT_RCS_X_PISTOL, 0.0f);
		set(V_AIMBOT_RCS_Y_PISTOL, 0.0f);
		set(V_AIMBOT_RCS_X_RIFLE, 0.0f);
		set(V_AIMBOT_RCS_Y_RIFLE, 0.0f);
		set(V_AIMBOT_RCS_X_SNIPER, 0.0f);
		set(V_AIMBOT_RCS_Y_SNIPER, 0.0f);
		set(V_AIMBOT_RCS_X_HEAVY, 0.0f);
		set(V_AIMBOT_RCS_Y_HEAVY, 0.0f);
		set(V_AIMBOT_RCS_X_SMG, 0.0f);
		set(V_AIMBOT_RCS_Y_SMG, 0.0f);
		...
		set(V_ESP_HEALTH_GRADIENT_COL_R, 63);
		set(V_ESP_HEALTH_GRADIENT_COL_G, 139);
		set(V_ESP_HEALTH_GRADIENT_COL_B, 222);
		set(V_ESP_HEALTH_GRADIENT_COL2_R, 205);
		set(V_ESP_HEALTH_GRADIENT_COL2_G, 76);
		set(V_ESP_HEALTH_GRADIENT_COL2_B, 218);
		...
		set(V_ESP_ARMOR_TYPE, 0);
		set(V_ESP_ARMOR_BATTERY, true);
		set(V_ESP_ARMOR_COL_R, 255);
		set(V_ESP_ARMOR_COL_G, 255);
		set(V_ESP_ARMOR_COL_B, 255);
		set(V_ESP_ARMOR_GRADIENT_COL_R, 205);
		set(V_ESP_ARMOR_GRADIENT_COL_G, 76);
		set(V_ESP_ARMOR_GRADIENT_COL_B, 218);
		set(V_ESP_ARMOR_GRADIENT_COL2_R, 63);
		set(V_ESP_ARMOR_GRADIENT_COL2_G, 139);
		set(V_ESP_ARMOR_GRADIENT_COL2_B, 222);
		...
		set(V_VISUALS_INTERFACE_STATUS_TIME, false);
		set(V_VISUALS_INTERFACE_STATUS_TIME_PLAYING, false);
		set(V_VISUALS_INTERFACE_SPECTATORS, false);
		set(V_VISUALS_INTERFACE_SPECTATORS_POS_Y, 30.0f);
		set(V_VISUALS_WORLD_GRENADES_ENABLED, false);
		set(V_VISUALS_WORLD_GRENADES_DISTANCE, false);
		set(V_VISUALS_WORLD_GRENADES_TYPE, 0);
		set(V_VISUALS_WORLD_GRENADES_COL_R, 255);
		set(V_VISUALS_WORLD_GRENADES_COL_G, 255);
		set(V_VISUALS_WORLD_GRENADES_COL_B, 255);
