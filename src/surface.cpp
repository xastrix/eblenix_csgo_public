...
void c_surface_draw_manager::set_text_color(int r, int g, int b, int a)
{
	using original_fn = void(__thiscall*)(c_surface_draw_manager*, int, int, int, int);
...
void c_surface_draw_manager::draw_text_font(surface_font_t font)
{
	using original_fn = void(__thiscall*)(c_surface_draw_manager*, unsigned long);
	return (*(original_fn**)this)[23](this, font);
}

void c_surface_draw_manager::draw_text_pos(int x, int y)
{
	using original_fn = void(__thiscall*)(c_surface_draw_manager*, int, int);
	return (*(original_fn**)this)[26](this, x, y);
}

void c_surface_draw_manager::draw_render_text(const wchar_t* text, int len)
{
	using original_fn = void(__thiscall*)(c_surface_draw_manager*, const wchar_t*, int, int);
	return (*(original_fn**)this)[28](this, text, len, 0);
}
...
surface_font_t c_surface_draw_manager::font_create()
{
	using original_fn = surface_font_t(__thiscall*)(c_surface_draw_manager*);
	return (*(original_fn**)this)[71](this);
}

void c_surface_draw_manager::set_font_glyph(surface_font_t font, const char* name, int tall, int weight, int blur, int scanlines, int flags)
{
	using original_fn = void(__thiscall*)(c_surface_draw_manager*, surface_font_t, const char*, int, int, int, int, int, int, int);
	return (*(original_fn**)this)[72](this, font, name, tall, weight, blur, scanlines, flags, 0, 0);
}
