...
int c_base_player::get_health()
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_iHealth"));
}

vec3 c_base_player::get_velocity()
{
	return *reinterpret_cast<vec3*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_BasePlayer::m_vecVelocity[0]"));
}

vec3 c_base_player::get_view_offset()
{
	return *reinterpret_cast<vec3*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_BasePlayer::m_vecViewOffset[0]"));
}
...
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_nTickBase"));
}

int c_base_player::get_flags()
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_fFlags"));
}

bool c_base_player::is_life_state()
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_lifeState")) == 0;
}
...
bool c_base_player::has_gun_game_immunity()
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_bGunGameImmunity"));
}

int c_base_player::hitbox_set()
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_BasePlayer::m_nHitboxSet"));
}

vec3 c_base_player::aim_punch_angle()
{
	return *reinterpret_cast<vec3*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_BasePlayer::m_aimPunchAngle"));
}

bool c_base_player::is_scoped()
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_bIsScoped"));
}

float c_base_player::get_flash_duration()
{
	return *reinterpret_cast<float*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_flFlashDuration"));
}
...
{
	return *reinterpret_cast<int*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_ArmorValue"));
}

vec3 c_base_player::get_eye_angles()
{
	return *reinterpret_cast<vec3*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_angEyeAngles"));
}

bool c_base_player::has_helmet()
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_bHasHelmet"));
}

bool c_base_player::has_defuser()
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_CSPlayer::m_bHasDefuser"));
}
