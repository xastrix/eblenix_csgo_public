...
bool c_base_plantedc4::bomb_ticking()
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_PlantedC4::m_bBombTicking"));
}

float c_base_plantedc4::defuse_count_down()
{
	return *reinterpret_cast<float*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_PlantedC4::m_flDefuseCountDown"));
}
...
{
	return *reinterpret_cast<bool*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_PlantedC4::m_bBombDefused"));
}

float c_base_plantedc4::c4_blow()
{
	return *reinterpret_cast<float*>(uintptr_t(this) +
		g_netvars.get_netvar("DT_PlantedC4::m_flC4Blow"));
}
